return {
	...
	},
	{
		...
		opts = {
			...
			system_clipboard = {
				sync_with_ring = vim.env.SSH_TTY == nil,
				clipboard_register = "+",
			},
			highlight = {
				on_put = true,
		...
		keys = {
			...
			{ "]p", "<Plug>(YankyPutIndentAfterLinewise)", desc = "Put Below and Match Indent" },
			{ "[p", "<Plug>(YankyPutIndentBeforeLinewise)", desc = "Put Above and Match Indent" },
			{ "]P", "<Plug>(YankyPutIndentAfterLinewise)", desc = "Put Below and Match Indent" },
			{ "[P", "<Plug>(YankyPutIndentBeforeLinewise)", desc = "Put Above and Match Indent" },
			{ ">p", "<Plug>(YankyPutIndentAfterShiftRight)", desc = "Put Below and Shift Right" },
			{ "<p", "<Plug>(YankyPutIndentAfterShiftLeft)", desc = "Put Below and Shift Left" },
			{ ">P", "<Plug>(YankyPutIndentBeforeShiftRight)", desc = "Put Above and Shift Right" },
			{ "<P", "<Plug>(YankyPutIndentBeforeShiftLeft)", desc = "Put Above and Shift Left" },
